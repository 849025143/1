...
package com.andwhat5.ggyms.config;

import net.minecraft.util.text.TextFormatting;

public class GGymTheme {
	
	public static TextFormatting badgeTagColor = TextFormatting.LIGHT_PURPLE;
	
	public static TextFormatting badgeLoreColor = TextFormatting.AQUA;
}
